    ...
    while(1)
    {
        ...
        if(color==1) 
        {
        	...
        	if(n==5)//第三手 
        	{
        	    ...
        	    else if(qipan[a-2][b-1]==2)
        		{
        			i=a-1;j=b;
        		}
        		else if(qipan[a-1][b-2]==2)
        		{
        			i=a;j=b-1;
        		}
          	...
          	if(n==7)//第四手 
          	{
          		...
          		else if(qipan[8-1][8-1]==qipan[9-1][8-1]==qipan[7-1][8-1]==1&&qipan[10-1][8-1]==2)
				  {
				  	i=10;j=8; 
				  } 
				  else if(qipan[8-1][8-1]==qipan[9-1][8-1]==qipan[7-1][8-1]==1&&qipan[6-1][8-1]==2)
				  {
				  	i=6;j=8; 
				  } 
          	...
          	if(n==9)//第五手 
          	{
          		...
          		else if(qipan[8-1][8-1]==qipan[9-1][8-1]==qipan[7-1][8-1]==qipan[10-1][8-1]==1&&qipan[11-1][8-1]==2)
				  {
				  	i=11;j=8; 
				  } 
				  else if(qipan[8-1][8-1]==qipan[9-1][8-1]==qipan[7-1][8-1]==qipan[6-1][8-1]==1&&qipan[5-1][8-1]==2)
				  {
				  	i=5;j=8; 
				  } 
          		else if(qipan[10-1][8-1]==qipan[11-1][8-1]==qipan[12-1][8-1]==0&&qipan[13-1][8-1]==2)
          	  	{
          	  		i=13;j=8;
          	  	}
          		else if(qipan[8-1][8-1]==qipan[9-1][8-1]==qipan[7-1][7-1]==1&&qipan[9-1][9-1]==2)
          		{
          			i=9;j=9;
          		}
          	  ...
          	  if(n==11)//第六手 
          	  {
          	  	...
          	  	else if(qipan[10-1][8-1]==qipan[11-1][8-1]==qipan[12-1][8-1]==qipan[13-1][8-1]==0&&qipan[14-1][8-1]==2)
          	  	{
          	  		i=14;j=8;
          	  	}
          	  	else if(qipan[8-1][8-1]==qipan[9-1][8-1]==qipan[7-1][7-1]==qipan[9-1][9-1]==1&&qipan[10-1][10-1]==2)
          		{
          			i=10;j=10;
          		}
 ...
 if(color==2)
 {
    ...
    while(1)
    {
        ...
        if(color==0) 
        {
        	...
        	if(n==6)//第三手 
        	{
        		if(qipan[9-1][9-1]==0&&qipan[10-1][9-1]==2)
        		{
        			i=10;j=9;
        		}
        		else if(qipan[8-1][10-1]==0&&qipan[8-1][11-1]==2)
        		{
        			i=8;j=11;
        		}
				else if(qipan[8-1][10-1]==0&&qipan[8-1][11-1]==1&&qipan[9-1][10-1]==2)
        		{
        			i=9;j=10;
        		}
          	...
          	if(n==8)//第四手 
          	{
          		...
          		else if(qipan[8-1][9-1]==qipan[9-1][9-1]==qipan[10-1][9-1]==0&&qipan[11-1][9-1]==2)
          		{
          			i=11;j=9;
          		}
          	...
          	if(n==10)//第五手 
          	{
          		...
          		else if(qipan[8-1][9-1]==qipan[9-1][9-1]==qipan[10-1][9-1]==qipan[11-1][9-1]==0&&qipan[12-1][9-1]==2)
          		{
          			i=12;j=9;
          		}
