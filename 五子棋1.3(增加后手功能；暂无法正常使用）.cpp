    ...
    while(1)
    {
        ...
        if(color==1) 
        {
        	...
        	if(n==5)//第三手 
        	{
        	    ...
        	    else if(qipan[8-1][9-1]==qipan[8-1][8-1]==1&&qipan[8-1][7-1]==0&&qipan[8-1][10-1]==0&&qipan[7-1][8-1]==2)
        	    {
        	    	i=7;j=8;
        	    }
    ...
    while(1)
    {
        ...
        if(color==1) 
        {
        	...
        	if(n==6)//第三手 
        	{
        		...
        		if(qipan[8-1][10-1]==2&&qipan[8-1][9-1]==1)
        		{
        			i=8;j=10;
        		}
        		
        		if(qipan[10-1][8-1]==0&&qipan[9-1][9-1]==2)
        		{
        			i=9;j=9;
        		}
        	    else
